...
class Limit extends Component {
    ...
    getData = () => {
        return [
            ...
            { "U_ID": "T02", "ip_addr": "122.237.154.53", "D_ADDTIME": "2018-09-10", "status": "1" },
        ]
    }
        ...
        return (
            <Container>
                ...
                <ActionsBar>
                    ...
                    <Space>
                        <Button type="primary" onClick={() => { this.skipRouteToAdd() }}>添加限制IP地址</Button>
                        <Button type="danger" onClick={this.handelActionsBarDelete}>解除IP限制</Button>
                    </Space>
                    ...
                    <GridColumn title="操作" align="center"
                        render={({ row }) => (
                            <div style={{ padding: 4 }}>
                                ...
                                <Space>
                                    <Button onClick={() => { this.skipRouteToAdd() }} type="primary">编辑</Button>
                                    <Button onClick={this.handelActionsBarDelete} type="danger">解除</Button>
                                </Space>
